...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "LUXE TIME DZ" },
      { property: "og:site_name", content: "LUXE TIME DZ" },
      { property: "og:locale", content: "ar_DZ" },
      { property: "og:locale:alternate", content: "fr_DZ" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "LUXE TIME DZ",
          url: "https://luxe-time-dz-magic.lovable.app",
          logo: "https://luxe-time-dz-magic.lovable.app/favicon.ico",
          sameAs: [],
          areaServed: "DZ",
        }),
      },

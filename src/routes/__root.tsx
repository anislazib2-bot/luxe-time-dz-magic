...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "LUXE TIME DZ — ساعات فاخرة في الجزائر" },
      { property: "og:description", content: "متجر الساعات الفاخرة الأول في الجزائر. ساعات أصلية للرجال والنساء بأفضل الأسعار مع التوصيل لجميع الولايات." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "LUXE TIME DZ — ساعات فاخرة في الجزائر" },
      { name: "twitter:description", content: "متجر الساعات الفاخرة الأول في الجزائر. ساعات أصلية للرجال والنساء بأفضل الأسعار مع التوصيل لجميع الولايات." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/945f6153-c322-4356-9829-f4d52c5b2ad1/id-preview-036e4f42--af9c47e8-be0b-4b74-8b79-18a6486e1ca2.lovable.app-1782858212008.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/945f6153-c322-4356-9829-f4d52c5b2ad1/id-preview-036e4f42--af9c47e8-be0b-4b74-8b79-18a6486e1ca2.lovable.app-1782858212008.png" },
    ],
    links: [
